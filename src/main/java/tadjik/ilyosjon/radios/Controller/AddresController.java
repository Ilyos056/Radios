...
import tadjik.ilyosjon.radios.service.AddresService;
...
public class AddresController {
    ...
    public HttpEntity<?> findAll() {
        List<Addres> getall = addresService.getAll();
    ...
    public HttpEntity<?> findById(@PathVariable Integer id) {
        Addres service = addresService.getById(id);
        return new ResponseEntity<>(service, HttpStatus.OK);
    }

    @PreAuthorize("hasAnyRole('USER', 'ADMIN', 'SUPERADMIN' , 'MODERATOR')")
    @PostMapping
    public HttpEntity<?> create(@RequestBody AddresDto addresDto) {
        Result result = addresService.create(addresDto);
        return new ResponseEntity<>(result, HttpStatus.CREATED);
    }

    @PreAuthorize("hasAnyRole('USER', 'ADMIN', 'SUPERADMIN' , 'MODERATOR')")
    @PutMapping("/{id}")
    public HttpEntity<?> update(@PathVariable Integer id, @RequestBody AddresDto addresDto) {
        Result update = addresService.update(id, addresDto);
    ...
    public HttpEntity<?> delete(@PathVariable Integer id) {
        Result delete = addresService.delete(id);
