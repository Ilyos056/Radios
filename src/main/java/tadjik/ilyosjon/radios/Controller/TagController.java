...
import tadjik.ilyosjon.radios.service.TagService;
...
public class TagController {
    ...
    public HttpEntity<?> findAll() {
        List<Tag> getall = tagService.findAll();
    ...
    public HttpEntity<?> findById(@PathVariable Integer id) {
        Tag service = tagService.findById(id);
    ...
    public HttpEntity<?> update(@PathVariable Integer id, @RequestBody TagDto tagDto) {
        Result update = tagService.update(id, tagDto);
